...
const PlayStationGame = ({
  ...
  return (
    <>
      {filteredByPlayStatiom.length > 0 ? (
        <div className="List-section">
          {filteredByPlayStatiom.map((game: GameI) => (
            <div
            ...
            >
              <Link
                to={`/About/${game.id}`}
                state={{ games: filteredByPlayStatiom }}
              >
                {" "}
                {/*
            Передача даних */}
...
export default PlayStationGame;
